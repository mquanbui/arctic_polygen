...
/* Procedure to compute dihedral angles of general polyhedron */
/* If the polyhedron is of a specific type, say a tet, pyramid, prism
   ...
   argument. So one can call PR_Angles(rxyz, n, cosangs, 0, 0, 0, 0); */
...
void PR_Angles(double (*rxyz)[3], int n, double *angles,
